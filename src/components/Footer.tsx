        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-muted-foreground hover:text-foreground">Core Platform</a></li>
              <li><a href="#" className="text-muted-foreground hover:text-foreground">Solution Kits</a></li>
              <li><a href="#" className="text-muted-foreground hover:text-foreground">Enterprise Features</a></li>
              <li><a href="#" className="text-muted-foreground hover:text-foreground">AI Migration</a></li>
